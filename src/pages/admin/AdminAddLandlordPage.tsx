          ...
          >
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm placeholder:text-gray-400 focus:border-[#006948] focus:outline-none focus:ring-2 focus:ring-[#006948] dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:placeholder:text-slate-500"
              />
            </div>
          </FieldGroup>
        </div>
